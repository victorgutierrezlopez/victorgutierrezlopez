...
I am a **Software & Multiplatform Developer** focused on building efficient, scalable applications and diving deep into **Cybersecurity and Secure Coding**. 

My core strength lies in combining solid software architecture with a security-first mindset. From mobile apps to backend logic, I enjoy dissecting how systems work, optimizing performance, and mitigating potential vulnerabilities before they reach production.

- 💻 **Development Stack:** Java, Kotlin, Python, JavaScript, Dart (Flutter), React, SQL.
- 🛡️ **Systems & Security Focus:** Linux/Bash, Docker, Network Analysis (Wireshark), OWASP Top 10.
- ⚙️ **Workflow & Mindset:** Agile, Problem-Solver, Continuous Learner, Code Quality Advocate.

💡 *Currently honing my skills in offensive security, vulnerability analysis, and infrastructure security.*
